...
- [To-Do](#to-do)
  ...
  * [Credits](#credits-and-thanks-to)
  ...
  <p><a href="https://github.com/Lismilechu/tgtlg"> <img src="https://img.shields.io/badge/Deploy%20To%20Heroku-blueviolet?style=for-the-badge&logo=heroku" width="200""/></a></p>

  ## Deploy on VPS

  - Clone this repo:
  ```
  git clone -b main https://github.com/Lismilechu/tgtlg tgtlg
  cd tgtlg
  ```
